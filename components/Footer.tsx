    ...
    <footer className="relative bg-[#050B16] text-white mt-20 border-t border-cyan-500/20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed text-sm">
              Solutions techniques complètes : électricité,
              informatique, domotique et sécurité électronique.
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 text-center text-xs">
              ...
              <div className="flex flex-col items-center gap-2">
                <House className="text-cyan-400" size={26} />
                <span>Domotique</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                <Camera className="text-cyan-400" size={26} />
                <span>Contrôle</span>
              </div>
          ...
          <div>
            ...
            <div className="space-y-5 text-gray-300 text-sm">
              <div className="flex items-center gap-3">
                ...
                <a
                  href="mailto:dancheffo29@gmail.com"
                  className="hover:text-cyan-400 transition"
                >
                  dancheffo29@gmail.com
                </a>
              </div>
        ...
        <div className="border-t border-white/10 mt-14 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
          <p>
            © {new Date().getFullYear()} Tech Innov'Solutions.
          ...
          <div className="flex gap-6">
            ...
            <Link href="/mentions" className="hover:text-cyan-400 transition">
              Mentions légales
            </Link>
          </div>
        </div>
